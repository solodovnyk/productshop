...
public class AuthenticationManager {
	...
	public int getUserRoleID() throws site.productshop.security.SecurityException {
		...
		try {
			...
			throw new site.productshop.security.SecurityException(e.getMessage(), e);
		}
		
		return userRole;
	}
	
	public boolean hasAccess(int[] allowedRoles) throws site.productshop.security.SecurityException {
